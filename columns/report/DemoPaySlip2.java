...
class DemoPaySlip2 extends JPanel implements ActionListener,Printable
{
	...
	//			----------Incentive Connection--------
		...
		//              ---------------SalaryDetails Connection --------------------------
				...
				lblHeadEmp=new JLabel("Mr.Harshal Nana Mali");
				lblHeadEmp.setFont(new Font("Arial",Font.BOLD,18));
				lblHeadEmp.setBounds(0,60,200,30);
				add(lblHeadEmp);
				...
				lblTotal.setBorder(new LineBorder(Color.BLACK,1));				lblTotal.setBounds(216,260,216,30);
				add(lblTotal);
